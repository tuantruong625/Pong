...
namespace PJTTAssignment4._4.Sprites
{
    public class Ball : Sprite
    {
        ...
        public Score Score;
        const int winScore = 2; // modify to change win score
        public Bat paddle;
        ...
        public override void Update(GameTime gameTime, List<Sprite> sprites)
        {
            ...
            {
                if (Score.Score1 == winScore || Score.Score2 == winScore)
                {
            ...
            if (Score.Score1 == winScore)
            {
                Score.message = "Pj wins, Press Space to start a new game.";
                Restart();
            }

            
            if (Score.Score2 == winScore)
            {
                Score.message = "Tuan wins, Press Space to start a new game.";
                Restart();    
            }
 
            //This will check score need to display message.
